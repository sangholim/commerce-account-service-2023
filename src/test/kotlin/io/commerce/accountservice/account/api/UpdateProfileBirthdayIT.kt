...
class UpdateProfileBirthdayIT(
    ...
    val uri = "/account/profile/$customerId/birthday"
    ...
    Given("프로필 생일 수정") {
        ...
        When("payload 유효성 검사 실패한 경우") {
            val invalidPayload = updateBirthdayPayload {
                this.birthday = " "
            }
